...
# [Distributed Training](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/contrib/distribute/README.md)
...
execution.
* TensorFlow currently supports the following predefined Keras callbacks:
`ModelCheckpointCallback`, `TensorBoardCallback`. Some of the other callbacks will soon be added support such as `EarlyStopping`, `ReduceLROnPlateau`, etc. If you
